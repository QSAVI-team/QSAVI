...
public class Rotate_Palm : MonoBehaviour {
	...
	public bool setSenterRotaionNow = false;
		...
		if(serialPort != null) {
			...
			if (isValidData) {
				...
				*/
				...
				if (setSenterRotaionNow) {
					setSenterRotaionNow = false;
